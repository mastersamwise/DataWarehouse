...
(
    IN @personFirstName     varchar(25),
    IN @personLastName      varchar(50),
    
    OUT band_name           varchar(100),
    OUT person_first_name   varchar(25),
    OUT person_last_name    varchar(25),
    OUT concert_date        datetime(6)
)
BEGIN

...
BEGIN
	...
	DECLARE id_ integer = (SELECT id_col_ FROM concertBand_xref_table_ ORDER BY id_ ASC LIMIT 1);
	DECLARE concert_id_ integer
	DECLARE band_name_ nvarchar (100)

	DECLARE band_id integer
